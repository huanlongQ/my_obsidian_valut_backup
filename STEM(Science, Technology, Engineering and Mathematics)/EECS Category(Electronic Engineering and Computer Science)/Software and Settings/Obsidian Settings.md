...
* zhihu **Foldersync**: https://www.zhihu.com/question/475280128/answer/2824365636 
...
.obsidian/workspace-LAPTOP-V7OJEVKD.json 
.obsidian/workspace-LAPTOP-V7OJEVKD-2.json 
.trash/*
.obsidian/cache 
```

`git plugin data.json` 
```json
{
  "commitMessage": "dorm PC end:{{date}}",
  "autoCommitMessage": "dorm PC end:{{date}}",
  "commitMessageScript": "",
...
* **picgo plugin** 
$\alpha \alpha\beta\gamma\Gamma \Lambda^{2}$ 
$H=\sum_{<ij>}-tc_{i}c^{\dagger}_{j}+h.c. + \sum_{i}Uc_{i,\uparrow}^{\dagger}c_{i,\uparrow}c_{i,\downarrow}^{\dagger}c_{i,\downarrow}$ 

# 3. code block paste

use `Ctrl + Alt + V`, otherwise weird blank lines would disturb. 

# 4. Multi Indents

[[20250725 泰安新赛道汇报|@20250725 泰安新赛道汇报]]
use `>`
>1
>>2
>>>3
...
or use `'-' + 'Tab'` 
![[Pasted image 20250726231723.png|286]] 
- 你好
	- 你好
		- 你好
			- 

# 5. LaTeX Suite Setting
...
![[Pasted image 20250909185739.png|671]] 

# 9. Checklist

![[Pasted image 20250909185750.png|688]] 
